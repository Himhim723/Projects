...
/**
 * This class is designed for the configuration of the application given that 
 * data of specific stocks should be installed into the application database 
 * right before the server start providing service
 * 
 */
...
public class AppStartRunner implements CommandLineRunner {
  ...
  public void run(String... args) throws FinnhubException {
    ...
    // Confirm all data has been removed in the database
